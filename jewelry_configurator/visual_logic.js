 ...
 * Wed Mar 04 2020 09:39:52 GMT+0300 (Moscow Standard Time)
...
function featureAvailable(feature) {
    ...
    case 'CARDBOARD':
        return v3d.Detector.checkCardboard();
    case 'WEBGL2':
...
function load_gem_set(gem_number) {
  ...
  appendScene(['gem_',gem_number,'.gltf.xz'].join(''), false, false, function() {
...
appendScene('gem_0.gltf.xz', false, false, function() {
  buttons_select_remove();
  gem_type = 0;
  html_buttons_acess_update();
  ring_update();
...
if (featureAvailable('MOBILE') == true) {
  tweenCamera('mobile_camera_place', 'camera_look_at', 0, function() {});
}
